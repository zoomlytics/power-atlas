...
## 3) Risk taxonomy (conceptual, v0.1)
...
8. **Security/abuse risk (conceptual)**
   ...
   - v0.1 acknowledges this category conceptually without prescribing controls in this document.
...
## 4) Misuse & abuse scenarios (illustrative, non-exhaustive)
...
## 5) Existing v0.1 mitigations / posture (mapped to boundary docs)

| Risk area | v0.1 boundary posture |
| --- | --- |
| Publication of potentially harmful semantic assertions | HITL publication boundary, attributable review expectations, and non-authoritative candidate/authoritative distinction in [`/docs/agents/governance-v0.1.md`](/docs/agents/governance-v0.1.md) |
| Authority laundering / hidden derivation | Provenance-first attribution, claim mediation, and transparency requirements in [`/docs/provenance/v0.1.md`](/docs/provenance/v0.1.md) |
| Silent revision / contested-state erasure | Revision auditability and coexistence of contradiction in [`/docs/provenance/epistemic-invariants-v0.1.md`](/docs/provenance/epistemic-invariants-v0.1.md) |
| Temporal collapse / decontextualized claims | Valid-time vs record-time distinctions and revision trace posture in [`/docs/architecture/temporal-modeling-v0.1.md`](/docs/architecture/temporal-modeling-v0.1.md) |
| Ranking harms / narrative escalation from metrics | Non-escalation language and heuristic-only framing in [`/docs/metrics/analysis-philosophy-v0.1.md`](/docs/metrics/analysis-philosophy-v0.1.md) |
| Identity conflation and re-identification risk | Conservative link-first entity resolution and harm-minimization posture in [`/docs/ontology/entity-resolution-v0.1.md`](/docs/ontology/entity-resolution-v0.1.md) |
| Semantic drift from infrastructure choices | Semantic Core replaceability and boundary constraints in [`/docs/architecture/v0.1.md`](/docs/architecture/v0.1.md) and [`/docs/ontology/validation/semantic-invariants-v0.1.md`](/docs/ontology/validation/semantic-invariants-v0.1.md) |

v0.1 posture: these are conceptual guardrails and review expectations, not complete mitigations or enforcement guarantees.

---

## 6) Explicit non-goals / non-guarantees (v0.1)
...
## 7) Review checklist (implementation-agnostic, v0.1)
...
## 8) Open questions (v0.2+ forward alignment)
