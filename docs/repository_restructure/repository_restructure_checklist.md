...
| Committed run-output archival boundary (`demo/artifacts/`, `pipelines/runs/`) | Phase 10 | Ash | completed | Both roots are still active output locations; committed historical examples stay in place as reference material until runtime defaults and documentation references are intentionally decoupled |
