...
2026-05-07 at commit `4666f6ec2b97d9f158737ae537d6a8f2f1481383`, with artifacts
captured under `artifacts/repository_restructure/phase1/20260507T063610Z`.
...
`narrative_extraction_runtime`, `pdf_ingest_runtime`,
`structured_ingest_runtime`, `retrieval_runtime`, `graph_health`,
...
- backend/API exposed through the public `power_atlas.api` facade, with
  `interfaces/api` retained only as transitional compatibility wiring,
