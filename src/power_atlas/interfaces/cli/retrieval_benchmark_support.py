...
def default_retrieval_benchmark_cli_settings(
    *,
...
def build_retrieval_benchmark_cli_request_context(
    args: argparse.Namespace,
    *,
    app_baseline: AppBaseline | None = None,
):
    base_settings = default_retrieval_benchmark_cli_settings(app_baseline=app_baseline)
    settings = replace(
        base_settings,
        neo4j=replace(
            base_settings.neo4j,
...
def parse_retrieval_benchmark_args(
    ...
    *,
    ...
    resolved_baseline = resolve_app_baseline() if app_baseline is None else app_baseline
    package_settings = default_retrieval_benchmark_cli_settings(app_baseline=resolved_baseline)
...
__all__ = [
    ...
    "default_retrieval_benchmark_cli_settings",
